...
<div class="mb-4 fw-bold">Day 6 - Practice 1: Program to create Calculator functionality.</div>
...
<div class="d-flex align-self-center justify-content-center">
    <div class="d-inline border border-2 p-4 shadow p-3 mb-5 bg-body rounded">
        ...
        <div class="mt-4 fs-5 fw-bold text-dark">
            ...
            function operationCalculation($number1, $number2, $operation)
            {
                switch ($operation) {
                    case 'Addition':
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (trim($number1) == '' || trim($number2) == '') {
                    ...
                    operationCalculation($number1, $number2, $operation);
                }
            }
