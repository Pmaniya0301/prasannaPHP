...
<div class="mb-4 fw-bold">Task: Create a program to replace multiple characters from the string.</div>
        ...
        <div id="resultArea" class="mt-4 fs-5 fw-bold text-dark">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (trim($inputText) == '') {
                    ...
                    $characters = array(".", ",", "@", "\\", "\"", "'", "*", "-", "+", ":", "/");
                    echo 'Output String: ' .  trim(str_replace($characters, ' ', $inputText));
                }
            }
            ?>
        </div>
