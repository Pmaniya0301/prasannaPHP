...
<div class="mb-4 fw-bold">Task: Create a program to get the characters after the last '/' in an URL.</div>
        ...
        <div id="resultArea" class="mt-4 fs-5 fw-bold text-dark">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (trim($inputText) == '') {
                    ...
                    echo substr($inputText, strrpos($inputText, "/") + 1, strlen($inputText));

                    //Another Way
                    // $chunkString = explode("/", $inputText);
                    // echo 'Output String: ' . end($chunkString);
                }
            }
            ?>
        </div>
